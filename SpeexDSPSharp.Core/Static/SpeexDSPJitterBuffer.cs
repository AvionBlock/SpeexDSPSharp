...
{
    /// <summary>
    /// Speexdsp jitter buffer using static binding calls.
    /// </summary>
    public class SpeexDSPJitterBuffer : ISpeexDSPJitterBuffer
    {
        ...
        {
            _handler = StaticNativeSpeexDSP.jitter_buffer_init(step_size);
        }
        ...
        {
            ThrowIfDisposed();
            StaticNativeSpeexDSP.jitter_buffer_reset(_handler);
        }
        ...
        {
            ThrowIfDisposed();
            StaticNativeSpeexDSP.jitter_buffer_put(_handler, ref packet);
        }
        ...
        {
            ThrowIfDisposed();
            var result = StaticNativeSpeexDSP.jitter_buffer_get(_handler, ref packet, desired_span, (int*)start_offset);
        ...
        {
            ThrowIfDisposed();
            var result = StaticNativeSpeexDSP.jitter_buffer_get_another(_handler, ref packet);
            return result;
        }
        ...
        {
            ThrowIfDisposed();
            var result = StaticNativeSpeexDSP.jitter_buffer_update_delay(_handler, ref packet, (int*)start_offset);
            CheckError(result);
            return result;
        }
        ...
        {
            ThrowIfDisposed();
            return StaticNativeSpeexDSP.jitter_buffer_get_pointer_timestamp(_handler);
        }
        ...
        {
            ThrowIfDisposed();
            StaticNativeSpeexDSP.jitter_buffer_tick(_handler);
        }
        ...
        {
            ThrowIfDisposed();
            StaticNativeSpeexDSP.jitter_buffer_remaining_span(_handler, remaining_span);
        }
        ...
        public unsafe int Ctl<T>(JitterBufferCtl request, ref T value) where T : unmanaged
        {
            ...
            {
                var result = StaticNativeSpeexDSP.jitter_buffer_ctl(_handler, (int)request, valuePtr);
                CheckError(result);
                return result;
            }
        }
