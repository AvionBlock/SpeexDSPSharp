...
{
    /// <summary>
    /// Speexdsp echo cancellation using static binding calls.
    /// </summary>
    public class SpeexDSPEchoCanceler : ISpeexDSPEchoCanceler
    {
        ...
        {
            _handler = StaticNativeSpeexDSP.speex_echo_state_init(frame_size, filter_length);
        }
        ...
        {
            _handler = StaticNativeSpeexDSP.speex_echo_state_init_mc(frame_size, filter_length, nb_mic, nb_speaker);
        }
        ...
        {
            ThrowIfDisposed();
            StaticNativeSpeexDSP.speex_echo_state_reset(_handler);
        }
        ...
        public unsafe void EchoPlayback(Span<byte> play)
        {
            ...
            {
                StaticNativeSpeexDSP.speex_echo_playback(_handler, (short*)playPtr);
            }
        }
        ...
        public unsafe void EchoPlayback(Span<short> play)
        {
            ...
            {
                StaticNativeSpeexDSP.speex_echo_playback(_handler, playPtr);
            }
        }
        ...
        public unsafe void EchoCapture(Span<byte> rec, Span<byte> output)
        {
            ...
            {
                StaticNativeSpeexDSP.speex_echo_capture(_handler, (short*)recPtr, (short*)outPtr);
            }
        }
        ...
        public unsafe void EchoCapture(Span<short> rec, Span<short> output)
        {
            ...
            {
                StaticNativeSpeexDSP.speex_echo_capture(_handler, recPtr, outPtr);
            }
        }
        ...
        public unsafe void EchoCancel(Span<byte> rec, Span<byte> play, Span<byte> output)
        {
            ...
            fixed (byte* outPtr = output)
            {
                StaticNativeSpeexDSP.speex_echo_cancellation(_handler, (short*)recPtr, (short*)playPtr, (short*)outPtr);
            }
        }
        ...
        public unsafe void EchoCancel(Span<short> rec, Span<short> play, Span<short> output)
        {
            ...
            fixed (short* outPtr = output)
            {
                StaticNativeSpeexDSP.speex_echo_cancellation(_handler, recPtr, playPtr, outPtr);
            }
        }
        ...
        public unsafe int Ctl<T>(EchoCancellationCtl request, ref T value) where T : unmanaged
        {
            ...
            {
                var result = StaticNativeSpeexDSP.speex_echo_ctl(_handler, (int)request, valuePtr);
                CheckError(result);
                return result;
            }
        }
