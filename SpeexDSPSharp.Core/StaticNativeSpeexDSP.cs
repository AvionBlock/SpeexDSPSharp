...
namespace SpeexDSPSharp.Core
{
    ...
    /// </summary>
    public static class StaticNativeSpeexDSP
    {
        ...
        public static extern StaticSpeexDSPJitterBufferSafeHandler jitter_buffer_init(int step_size);
        ...
        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
        public static extern StaticSpeexDSPEchoStateSafeHandler speex_echo_state_init(int frame_size, int filter_length);
        ...
        /// <returns>Newly-created echo canceler state.</returns>
        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
        public static extern StaticSpeexDSPEchoStateSafeHandler speex_echo_state_init_mc(int frame_size, int filter_length, int nb_mic, int nb_speaker);
        ...
        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
        public static extern StaticSpeexDSPPreprocessStateSafeHandler speex_preprocess_state_init(int frame_size, int sampling_rate);
